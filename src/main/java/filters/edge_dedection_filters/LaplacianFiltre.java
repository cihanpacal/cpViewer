...
public class LaplacianFiltre implements IFilter {
	...
	public LaplacianFiltre() {
		this(IFilter.LAPLACIAN_ARTI_8);
	}
	
	public LaplacianFiltre(int filtre) {
		
		if(!(filtre==IFilter.LAPLACIAN_ARTI_4||filtre==IFilter.LAPLACIAN_EKSI_4||filtre==IFilter.LAPLACIAN_ARTI_8||filtre==IFilter.LAPLACIAN_EKSI_8)) {
